...
const BUILTIN_PROBE_INPUTS: readonly DescriptorInput[] = [
  ...
  {
    probeId: "test.active-supported.v1",
    purpose: "Fixed active-evidence supported fixture.",
    availability: "TEST_ONLY",
    capabilityId: "toolCalling",
    executableRule: "node-current",
    fixedArgs: ["-e","process.stdout.write('SUPPORTED')"],
    sideEffectClass: "READ_ONLY_LOCAL",
    networkPolicy: "DENY",
    timeoutMs: 1000,
    maxStdoutBytes: 64,
  ...
  {
    probeId: "test.active-unsupported.v1",
    purpose: "Fixed active-evidence unsupported fixture.",
    availability: "TEST_ONLY",
    capabilityId: "toolCalling",
    executableRule: "node-current",
    fixedArgs: ["-e","process.stdout.write('UNSUPPORTED')"],
    sideEffectClass: "READ_ONLY_LOCAL",
    networkPolicy: "DENY",
    timeoutMs: 1000,
    maxStdoutBytes: 64,
  ...
  {
    probeId: "test.enumeration-excluded.v1",
    purpose: "Fixed complete-enumeration exclusion fixture.",
    availability: "TEST_ONLY",
    capabilityId: "structuredOutput",
    executableRule: "node-current",
    fixedArgs: ["-e","process.stdout.write('EXCLUDED')"],
    sideEffectClass: "READ_ONLY_LOCAL",
    networkPolicy: "DENY",
    timeoutMs: 1000,
    maxStdoutBytes: 64,
  ...
  {
    probeId: "test.active-unrecognized.v1",
    purpose: "Fixed active-evidence unrecognized fixture.",
    availability: "TEST_ONLY",
    capabilityId: "toolCalling",
    executableRule: "node-current",
    fixedArgs: ["-e","process.stdout.write('MAYBE')"],
    sideEffectClass: "READ_ONLY_LOCAL",
    networkPolicy: "DENY",
    timeoutMs: 1000,
    maxStdoutBytes: 64,
  ...
  {
    probeId: "test.active-timeout.v1",
    purpose: "Fixed active-evidence timeout fixture.",
    availability: "TEST_ONLY",
    capabilityId: "toolCalling",
    executableRule: "node-current",
    fixedArgs: ["-e","setTimeout(()=>{},10000)"],
  ...
  {
    probeId: "test.active-blocked.v1",
    purpose: "Fixed active-evidence blocked fixture.",
    availability: "TEST_ONLY",
    capabilityId: "toolCalling",
    executableRule: "node-current",
    fixedArgs: ["--version"],
