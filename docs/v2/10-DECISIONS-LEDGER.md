...
| ADR-UADS2-009 | Use a local-first protocol-neutral Core with MCP as the primary agent interface and CLI retained for deterministic operations | ACCEPTED |
